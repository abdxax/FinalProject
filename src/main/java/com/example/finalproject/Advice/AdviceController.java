...
public class AdviceController {
    ...
    public ResponseEntity methodArgumentTypeMismatch(MethodArgumentTypeMismatchException e){
        return ResponseEntity.status(400).body(new ApiResponseWithUser(e.getMessage(),null));
    }
    ...
    public ResponseEntity dataIntegrityViolation(MethodArgumentNotValidException e){
        return ResponseEntity.status(400).body(new ApiResponseWithUser(e.getFieldError().getDefaultMessage(),null));
    }
